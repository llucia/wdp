 ...
 */
public class DMAEncodedVertexWithBidsInputFormat extends
        TextVertexInputFormat<EncodedGoodsWritable, EncodedVertexValueWithBidsWritable, NullWritable> {
     ...
     */
     class JsonWDPVertexIdDoubleFloatWDPMessageVertexReader extends
        ...
        @Override
        protected EncodedVertexValueWithBidsWritable getValue(JSONArray jsonVertex) throws
                JSONException, IOException {
            return new EncodedVertexValueWithBidsWritable(new EncodedVertexValueWithBids(
                    jsonVertex.getDouble(2),GetBids(jsonVertex.getLong(1))));
        }
        private long[] GetBids(long l)throws JSONException{
            long[]bids=new long[1];
            bids[0]=l;
            return bids;
        }
        ...
        */
        ...
        @Override
        protected Vertex<EncodedGoodsWritable, EncodedVertexValueWithBidsWritable, NullWritable>
