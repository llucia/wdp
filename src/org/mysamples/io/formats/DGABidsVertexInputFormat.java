 ...
 */
public class DGABidsVertexInputFormat extends
        TextVertexInputFormat<WDPVertexIdWritable, WDPMessageWritable, NullWritable> {
     ...
     class JsonWDPVertexIdDoubleFloatWDPMessageVertexReader extends
        ...
        protected WDPMessageWritable getValue(JSONArray jsonVertex) throws
            ...
            return new WDPMessageWritable(new WDPMessage(
                    ...
                    new WDPVertexId( jsonVertex.getJSONArray(0)))
            );
        }
        ...
        */
        @Override
        protected Iterable<Edge<WDPVertexIdWritable, NullWritable>> getEdges(
                JSONArray jsonVertex) throws JSONException, IOException {

            WDPVertexIdWritable sourceVertex=getId(jsonVertex);
            JSONArray jsonEdgeArray = jsonVertex.getJSONArray(2);
            List<Edge<WDPVertexIdWritable, NullWritable>> edges =
            ...
            for (int i = 0; i < jsonEdgeArray.length(); ++i) {
                ...
                if (sourceVertex.get().IsNotConflictingWith(wdpVertexIdWritable.get()))
                    edges.add(EdgeFactory.create(wdpVertexIdWritable, NullWritable.get()));
            }
            return edges;
        }

        @Override
        protected Vertex<WDPVertexIdWritable, WDPMessageWritable, NullWritable>
