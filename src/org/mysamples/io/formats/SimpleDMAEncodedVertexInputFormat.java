 ...
 */
public class SimpleDMAEncodedVertexInputFormat extends
        TextVertexInputFormat<EncodedGoodsWritable, EncodedVertexValueWritable, NullWritable> {
     ...
     */
     class JsonWDPVertexIdDoubleFloatWDPMessageVertexReader extends
        ...
        @Override
        protected EncodedVertexValueWritable getValue(JSONArray jsonVertex) throws
                JSONException, IOException {
            return new EncodedVertexValueWritable(jsonVertex.getDouble(1));
        }
        ...
        */
        ...
        @Override
        protected Vertex<EncodedGoodsWritable, EncodedVertexValueWritable, NullWritable>
