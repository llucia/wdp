...
public class AggregateDGAComputation extends BasicComputation<
    ...
    private static final Logger LOG =
            Logger.getLogger(AggregateDGAComputation.class);
        ...
        else
        {
            ...
            for (WDPMessageWritable message : messages) {
                ...
                if (!IsDummyMessage(message)) {
                   ...
                   if(CreateVertex(newVertexIndex, vertex, vertexValue, message))
                    newVertexNum++;
                }
            }
    ...
    private boolean CreateVertex(WDPVertexId newVertexId, Vertex<WDPVertexIdWritable, DoubleWritable, FloatWritable> vertex, double vertexValue, WDPMessageWritable message) throws IOException {
        ...
        if(vertexCreated ||  ((DoubleWritable)getAggregatedValue(MAX_AGG)).get()<newValue.get()) {
