...
public class DGABidsVertexComputation extends BasicComputation<
        WDPVertexIdWritable, WDPMessageWritable, NullWritable, WDPMessageWritable> {

    /**
     * Class logger
     */
    private static final Logger LOG =
            Logger.getLogger(DGABidsVertexComputation.class);

    public void log_info(Vertex<WDPVertexIdWritable, WDPMessageWritable, NullWritable>  vertex) {
        if (LOG.isInfoEnabled()) {
            ...
            for (Edge<WDPVertexIdWritable, NullWritable> edge : vertex.getEdges()) {
    ...
    @Override
    public void compute(Vertex<WDPVertexIdWritable, WDPMessageWritable, NullWritable> vertex,
    ...
    private void sendMessageToNonConflictingEdges(Vertex<WDPVertexIdWritable, WDPMessageWritable, NullWritable> vertex, WDPMessageWritable message) {
        for (Edge<WDPVertexIdWritable, NullWritable> edge : vertex.getEdges()) {
            if (message.get().getVertexId().IsNotConflictingWith(edge.getTargetVertexId().get())) {
                sendMessage(
    ...
    private void RemoveVertex(Vertex<WDPVertexIdWritable, WDPMessageWritable, NullWritable> vertex) throws IOException {
