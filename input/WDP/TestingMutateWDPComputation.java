 ...
 */
@Algorithm(
    name = "Testing Mutate WDP for Combinatorial Autions",
    description = "Computes the revenue for all vertexes in the graph returning only the roof vertexes"
)
public class TestingMutateWDPComputation extends BasicComputation<
    LongWritable, DoubleWritable, FloatWritable, DoubleWritable> {
  
  /** Class logger */
  private static final Logger LOG =
      Logger.getLogger(TestingMutateWDPComputation.class);
  ...
  public void compute(
    ...
    else
    {
	  ...
	  //send received value Validate messages.hasNext()
